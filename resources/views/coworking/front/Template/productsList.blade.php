...
<div class="card m-3" style="width: 20rem;">
    <div style="background-image: url('{{  asset('img/product_images/'.$product->url_img)  }}');" class="image-card">
    </div>
    <div class="card-body">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label>
                            <input type="radio" name="product_id" class="card-input-element d-none" id="demo1"
                                value="{{ $item->id }}">
                            <div
