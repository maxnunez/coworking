        ...
        <div class="row py-5 ">
            ...
            <div class="col-sm-12 col-md-6 wow animate__animated animate__bounceInRight">
                ...
                <p>
                    ...
                    maneja o
                    acepta dinero real, en este caso manejaremos el truque. La plataforma permite lograr una comunidad
                    más
                    sensible, más humana y más colaborativa ya que de esta manera nos podemos ayudar entre todos
                    ofreciendo lo
                    que tenemos y que no le damos uso (en el caso de bienes) y algo de lo cual tenemos conocimientos (en
                    el caso
    ...
    <div class="container">
        <div class="row py-5">
            ...
            <div class="col-sm-12 col-md-6 wow animate__animated animate__bounceInRight">
                ...
                <p>
                    En esta sección podemos encontrar información de interés general, relacionada con la plataforma de
                    intercambio
                    solidario, es decir que trate temas de consumo responsable, reciclaje y conciencia de consumo, así
                    mismo se
